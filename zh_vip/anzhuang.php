<?php
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_ad')."(
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_coupons')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_czhd')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_help')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_jfmx')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_level')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_order')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_qbmx')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户id',
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_store')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_system')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_user')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhvip_usercoupons')."(
  `id` int(11) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `coupons_id` int(11) NOT NULL,
...
if (!pdo_fieldexists(tablename('zhvip_order'), 'state')) {
    pdo_query("ALTER TABLE ".tablename('zhvip_order')." ADD `state`  INT NOT NULL DEFAULT '2';");
}
...
if (!pdo_fieldexists(tablename('zhvip_system'), 'jf_proportion')) {
    pdo_query("ALTER TABLE ".tablename('zhvip_system')." ADD `jf_proportion`  INT NOT NULL  DEFAULT '10';");
}
